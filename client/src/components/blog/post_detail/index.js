...
class PostDetail extends Component {
  ...
  renderUpdateAndDeleteButton() {
    if (this.props.allowChange) {
      return (
        <div>
          <button id='editbtn' className="btn  mr-1" onClick={this.onEditClick.bind(this)}>Edit</button>
          <button id='deletebtn' className="btn" data-toggle="modal" data-target="#deleteConfirmModal">Delete</button>
        </div>
      );
    }
  }
